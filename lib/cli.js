...
class CLI {
  ...
  run() {
    ...
    return writeFile(
      ...
      createDocument("bye", "green", "Circle", "yellow" )
    );*/
    return (
      inquirer
        .prompt([
          {
            ...
            name: "logoName",
            message:
              "Please enter logo name. You can enter up to three characters",
            maxLength: 3,
          },
          {
            type: "input",
            name: "textColor",
            message:
              "Enter prefered text color. You can enter color keyword (OR a hexadecimal number)",
          },
          {
            type: "checkbox",
            name: "shape",
          ...
          },
          {
            ...
            name: "shapeColor",
            message:
              "Enter prefered shape color. You can enter color keyword (OR a hexadecimal number)",
          },
        ])
        //User answers
        .then((res) => {
